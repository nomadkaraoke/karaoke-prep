...
class OldKaraokePrep:
    ...
    async def prep_single_track(self):
        ...
        try:
            ...
            if not self._file_exists(processed_track["title_video"]) and not os.environ.get("KARAOKE_GEN_SKIP_TITLE_END_SCREENS"):
            ...
            if not self._file_exists(processed_track["end_video"]) and not os.environ.get("KARAOKE_GEN_SKIP_TITLE_END_SCREENS"):
